...
symbolTable::symbolTable(string name_, symbolTable* parent = NULL):name(name_),tempcount(0){}
...
result(result),arg1(arg1_),op(op_),arg2(arg2_){}

quad::quad(string result_, int arg1_, string op_, string arg2_):
result(result),op(op_),arg2(arg2_){
